...
Region being a categorical variable, which is expressed through the dummies RegionMidwest, RegionSouth, and RegionWest (leaving out the Northeast.)
...
Plotting the residuals versus the predicted values shows no clear pattern, suggesting a sound model choice.
