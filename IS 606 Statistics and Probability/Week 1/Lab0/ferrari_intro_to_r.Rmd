...
2.  Is there an apparent trend in the number of girls baptized over the years?  
    ...
    The trend appears to include an overall rise as time goes on, with a trough 
...
# I see a plot of the proportion of boys baptized in Arbuthnot's dataset.
# There seems to be no clear trend, just a deviation about a mean.
...
# They are not on a similar scale, there are about 1000 times more baptisms in the present 
# data set.
```
...
# Arbuthnot's observation about boys being born in greater proportion stays true for the present data

# Lets also check out a plot of the proportion of boys compared to the total in this dataset
