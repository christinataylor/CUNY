...
There are 1000 cases (observations) in this data set.
...
The plot highlights that smokers have babies with slightly lower median birth-
weights. We can also get an idea of the skew of the data, the IQR between the 
2nd and third quartile is larger for smokers.
...
The sample sizes are large enough to use the normal distribution in our 
hypothesis testing (as long as the cases are independent). We won't need to use 
the t-distribution. 

4.  Write the hypotheses for testing if the average weights of babies born to 
smoking and non-smoking mothers are different.

$H_0$: There is no difference in average birthweight for newborns from mothers 
who did and did not smoke. $\mu_{nonsmoker} - \mu_{smoker} = 0$

$H_a$: There is a difference in these average birthweights. $\mu_{nonsmoker} - \mu_{smoker} \neq 0$
...
Our p-value is greater than 0.05, therefore we cannot reject the null hypothesis 
that the difference between these two means is 0.

-   Now, a non-inference task: Determine the age cutoff for younger and mature 
mothers. Use a method of your choice, and explain how your method works.

I used the median age as my cutoff between younger and mature mothers, which was 
27 years old. I included mothers that were 27 years old as "young".
...
I'll use whether or not the baby is premature as my categorical variable, and 
the age as my numerical variable. I'm going to see whether or not the mothers 
of premature babies are older or younger than the mothers of babies carried to 
full term.
...
I have a very high p-value of 0.8266, and therefore cannot reject the null 
hypothesis. It doesn't seem like the mothers of premature babies are older 
or younger than full-term babies.
