---
title: "The Effect of Weather on citiBike Usage, and a Geographic Analysis of Bike Flow"
...
There were a few important lessons working on this project taught me. This was larger than the other datasets we worked with in this class. My programming flow tends to involve a lot of trial and error, and I was forced to divide my work into chunks to get large jobs out of the way. For example, while originally when I was scraping the weather data, I was debugging the entire code that pulled the data from each individual website, a long process. When it became clear I was wasting time (and I stopped being stubborn thinking "this time there's no way it can't work!") I changed my code to pull in the raw data once, and then separated out the code that massages that raw data into the dataframe I needed.
